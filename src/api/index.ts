...
export const searchBookStore = (params: any, silent = false) => request.get('/records/books/search', { params, silent } as any)
export const getBookSourceDetail = (bookId: string, silent = false) => request.get(`/records/books/source/${encodeURIComponent(bookId)}/detail`, { silent } as any)
export const getBookSourceNotes = (bookId: string, silent = false) => request.get(`/records/books/source/${encodeURIComponent(bookId)}/notes`, { silent } as any)
export const getBookRecommendations = (params?: any, silent = false) => request.get('/records/books/recommendations', { params, silent } as any)
